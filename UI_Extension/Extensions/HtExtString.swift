...
//        var pos = -1
//        if let range = self.range(of: sub) { // rangeOfString(sub) {
//            if !range.isEmpty {
//                pos = self.startIndex.distanceTo(range.lowerBound) // startIndex)
//            }
//        }
//        return pos
//    }
    ...
    func getLength() -> Int {
        return self.lengthOfBytes(using: String.Encoding.ascii)
    }

    func getLengthUTF32() -> Int {
        return self.lengthOfBytes(using: String.Encoding.utf32BigEndian)
    }
